...
const OUTPUT_DIR = path.join(__dirname, 'output-002');
const DESKTOP = path.join(os.homedir(), 'Desktop');
const FILENAME = 'ENGLEAD_Phrasebook_PhoneCalls_002.pdf';
...
(async () => {
  console.log('ENGLEAD PDF Generator — Vol.002 Business Phone Calls');
  console.log('=====================================================\n');
